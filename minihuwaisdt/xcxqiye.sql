...
-- Records of lr_brand
-- ----------------------------
INSERT INTO `lr_brand` VALUES ('1', '品牌1', 'UploadFiles/brand/20170506/1494040580333912.jpg', '1', '1493177975', '0');
INSERT INTO `lr_brand` VALUES ('2', '品牌2', 'UploadFiles/brand/20170506/1494040592323613.jpg', '1', '1493185503', '0');
INSERT INTO `lr_brand` VALUES ('3', '品牌3', 'UploadFiles/brand/20170506/1494040603311031.jpg', '1', '1493185534', '0');
INSERT INTO `lr_brand` VALUES ('4', '品牌4', 'UploadFiles/brand/20170506/1494040614174988.jpg', '1', '1493185716', '0');
INSERT INTO `lr_brand` VALUES ('5', '品牌5', 'UploadFiles/brand/20170506/1494040656304679.jpg', '1', '1494040656', '0');
...
-- ----------------------------
INSERT INTO `lr_category` VALUES ('1', '0', '产品分类（系统分类，不要删除）', '0', '0', '', '', null, '', '0', null, '1', null);
INSERT INTO `lr_category` VALUES ('2', '1', '分类一', '1', '1493188517', '分类一', 'UploadFiles/category/20170516/1494900918581903.png', '1', null, '0', null, '1', 'UploadFiles/catBanner/20170516/1494900918149274.png');
INSERT INTO `lr_category` VALUES ('3', '1', '分类二', '2', '1493188587', '分类二', 'UploadFiles/category/20170426/1493188587759113.png', '1', null, '0', null, '1', null);
INSERT INTO `lr_category` VALUES ('4', '1', '分类三', '3', '1493188655', '分类三', 'UploadFiles/category/20170426/1493188655469022.png', '1', null, '0', null, '1', null);
INSERT INTO `lr_category` VALUES ('5', '1', '分类四', '1', '1493188735', '分类四', 'UploadFiles/category/20170426/1493188735709743.jpg', '1', null, '0', null, '1', null);
INSERT INTO `lr_category` VALUES ('6', '1', '分类五', '2', '1493188880', '分类五', 'UploadFiles/category/20170426/1493188880999188.jpg', '1', null, '0', null, '1', null);
INSERT INTO `lr_category` VALUES ('7', '1', '分类六', '3', '1493188984', '分类六', 'UploadFiles/category/20170426/1493188984346324.jpg', '1', null, '0', null, '1', null);
INSERT INTO `lr_category` VALUES ('8', '1', '分类七', '0', '1494492072', '分类七', null, null, '', '0', null, '1', null);
INSERT INTO `lr_category` VALUES ('9', '1', '分类八', '0', '1494492092', '分类八', null, null, '', '0', null, '1', null);
INSERT INTO `lr_category` VALUES ('10', '0', '新闻分类（系统分类，不要删除）', '0', '0', null, null, null, null, '0', null, '1', null);
INSERT INTO `lr_category` VALUES ('11', '10', '国内新闻', '0', '0', '国内新闻', null, null, null, '0', null, '1', null);
INSERT INTO `lr_category` VALUES ('12', '10', '国外新闻', '0', '0', '国外新闻', null, null, null, '0', null, '1', null);
...
-- ----------------------------
INSERT INTO `lr_guanggao` VALUES ('2', '首页轮播2', 'UploadFiles/adv/20170531/1496199365306610.png', '0', '0', '', '', '1');
INSERT INTO `lr_guanggao` VALUES ('5', '首页轮播3', 'UploadFiles/adv/20170531/1496199381172146.png', '0', '1000', '', '', '1');
INSERT INTO `lr_guanggao` VALUES ('8', '首页轮播4', 'UploadFiles/adv/20170428/1493349706309378.jpg', '0', '0', '', '', '1');
INSERT INTO `lr_guanggao` VALUES ('10', '首页轮播1', 'UploadFiles/adv/20170531/1496199355686842.png', '1493349922', '0', '', '', '1');
...
-- ----------------------------
-- Table structure for `lr_index_midcat`
-- ----------------------------
DROP TABLE IF EXISTS `lr_index_midcat`;
CREATE TABLE `lr_index_midcat` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of lr_index_midcat
-- ----------------------------
INSERT INTO `lr_index_midcat` VALUES ('5', '7', '分类六', 'UploadFiles/category/20170609/1496972479108589.png', '0', '新品推荐');
INSERT INTO `lr_index_midcat` VALUES ('6', '8', '分类七', 'UploadFiles/category/20170609/1496972495411553.png', '0', '热卖');
INSERT INTO `lr_index_midcat` VALUES ('7', '9', '分类八', 'UploadFiles/category/20170609/1496972508361997.png', '0', '大力推荐');

-- ----------------------------
-- Table structure for `lr_index_topcat`
-- ----------------------------
DROP TABLE IF EXISTS `lr_index_topcat`;
CREATE TABLE `lr_index_topcat` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cid` int(11) NOT NULL DEFAULT '0' COMMENT '分类ID',
  `name` varchar(50) DEFAULT NULL COMMENT '分类产品',
  `photo` varchar(100) NOT NULL COMMENT '图片',
...
-- ----------------------------
-- Records of lr_index_topcat
-- ----------------------------
INSERT INTO `lr_index_topcat` VALUES ('5', '2', '分类一', 'UploadFiles/category/20170609/1496972421645924.jpg', '0');
INSERT INTO `lr_index_topcat` VALUES ('6', '3', '分类二', 'UploadFiles/category/20170609/1496972431521124.jpg', '0');
INSERT INTO `lr_index_topcat` VALUES ('7', '4', '分类三', 'UploadFiles/category/20170609/1496972441655152.jpg', '0');
INSERT INTO `lr_index_topcat` VALUES ('8', '5', '分类四', 'UploadFiles/category/20170609/1496972450996859.jpg', '0');
INSERT INTO `lr_index_topcat` VALUES ('9', '6', '分类五', 'UploadFiles/category/20170609/1496972461739938.jpg', '0');
...
-- ----------------------------
-- Table structure for `lr_news_dp`
-- ----------------------------
DROP TABLE IF EXISTS `lr_news_dp`;
CREATE TABLE `lr_news_dp` (
...
-- ----------------------------
INSERT INTO `lr_program` VALUES ('1', '企业版', '企业版', 'UploadFiles/logo/1494469812587972.jpg', 'Copyright © 2017', 'weixin', '0200202002', '1496885395');
...
-- Records of lr_web
-- ----------------------------
INSERT INTO `lr_web` VALUES ('1', '0', '关于我们', '', '0', '关于我们', '1494486639');
INSERT INTO `lr_web` VALUES ('2', '0', '旗下品牌', '', '0', '旗下品牌', '1493257505');
INSERT INTO `lr_web` VALUES ('3', '0', '分公司介绍', null, '0', '分公司介绍', '0');
INSERT INTO `lr_web` VALUES ('4', '0', '公益事业', null, '0', '公益事业', '0');
INSERT INTO `lr_web` VALUES ('5', '0', '专家委员', null, '0', '专家委员', '0');
INSERT INTO `lr_web` VALUES ('6', '0', '售后服务', null, '0', '售后服务', '0');
