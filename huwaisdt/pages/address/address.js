...
Page({
  ...
  formSubmit: function (e) {
    ...
    wx.request({
      url: app.d.myUrl + '/Api/Address/add_adds',
      data: {
  ...
  onLoad: function (options) {
    ...
    //获取省级城市
    wx.request({
      url: app.d.myUrl + '/Api/Address/get_province',
      data: {},
      method: 'POST',
      success: function (res) {
        var status = res.data.status;
  ...
  bindPickerChangeshengArr: function (e) {
    ...
    var that = this;
    wx.request({
      url: app.d.myUrl + '/Api/Address/get_city',
  ...
  bindPickerChangeshiArr: function (e) {
    ...
    var that = this;
    wx.request({
      url: app.d.myUrl + '/Api/Address/get_area',
      data: {
        city:e.detail.value,
        sheng:this.data.sheng
      },
  ...
  bindPickerChangequArr: function (e) {
    ...
    var that = this;
    wx.request({
      url: app.d.myUrl + '/Api/Address/get_code',
      data: {
        quyu:e.detail.value,
        city:this.data.city
      },
